...
namespace MinWebShop {
    ...
    public partial class Webshop_DBDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomerRow AddCustomerRow(string Firstname, string Lastname, System.DateTime Date, string Username, string Password) {
...
namespace MinWebShop.Webshop_DBDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customer] WHERE (([CustomerID] = @Original_CustomerID) AND ([Firstname] = @Original_Firstname) AND ([Lastname] = @Original_Lastname) AND ([Date] = @Original_Date) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customer] ([Firstname], [Lastname], [Date], [Username], [Password]) VALUES (@Firstname, @Lastname, @Date, @Username, @Password);
SELECT CustomerID, Firstname, Lastname, Date, Username, Password FROM Customer WHERE (CustomerID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [Firstname] = @Firstname, [Lastname] = @Lastname, [Date] = @Date, [Username] = @Username, [Password] = @Password WHERE (([CustomerID] = @Original_CustomerID) AND ([Firstname] = @Original_Firstname) AND ([Lastname] = @Original_Lastname) AND ([Date] = @Original_Date) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password));
SELECT CustomerID, Firstname, Lastname, Date, Username, Password FROM Customer WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, Firstname, Lastname, Date, Username, Password FROM dbo.Custome" +
                "r";
        ...
        public virtual int Fill(Webshop_DBDataSet.CustomerDataTable dataTable) {
        ...
        public virtual Webshop_DBDataSet.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Webshop_DBDataSet.CustomerDataTable dataTable = new Webshop_DBDataSet.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Webshop_DBDataSet.CustomerDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CustomerID, string Original_Firstname, string Original_Lastname, System.DateTime Original_Date, string Original_Username, string Original_Password) {
        ...
        public virtual int Insert(string Firstname, string Lastname, System.DateTime Date, string Username, string Password) {
            if ((Firstname == null)) {
        ...
        public virtual int Update(string Firstname, string Lastname, System.DateTime Date, string Username, string Password, int Original_CustomerID, string Original_Firstname, string Original_Lastname, System.DateTime Original_Date, string Original_Username, string Original_Password, int CustomerID) {
            if ((Firstname == null)) {
                throw new global::System.ArgumentNullException("Firstname");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Firstname, string Lastname, System.DateTime Date, string Username, string Password, int Original_CustomerID, string Original_Firstname, string Original_Lastname, System.DateTime Original_Date, string Original_Username, string Original_Password) {
            return this.Update(Firstname, Lastname, Date, Username, Password, Original_CustomerID, Original_Firstname, Original_Lastname, Original_Date, Original_Username, Original_Password, Original_CustomerID);
        }
    }
